    ...
    <div class="container">
        <main class="main-content">
            ...
            <div class="search-filters">
                ...
                <form class="form-row" action="<%= request.getContextPath() %>/front/search/flight" method="post">
                    <div class="form-row">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <a href="${pageContext.request.contextPath}/front/detail/flight?id=<%= f.getId() %>" class="btn btn-secondary">Détails</a>
                                <%
                                    if (checkedSeats == null) {
                                        checkedSeats = new HashMap<>();
                                    }
                                %>

                                <% if(Boolean.TRUE.equals(checkedSeats.get(f.getId()))){ %>
                                    <a href="${pageContext.request.contextPath}/front/reserve/flight?id=<%= f.getId() %>" class="btn btn-primary">Réserver</a>
                                <% } %>
